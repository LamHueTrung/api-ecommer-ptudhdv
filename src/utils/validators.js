...
class Validator {
     ...
     /**
     * Kiểm tra tất cả các điều kiện và trả về danh sách lỗi
     * @param {Array<string|null>} validations - Mảng các lỗi hoặc null
     * @returns {Array<string>|null} - Danh sách lỗi hoặc null nếu hợp lệ
     */
